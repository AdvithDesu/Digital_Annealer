...
\figimg{fig:throughput}{Images/Fig4.png}{SA wall-clock per sweep iteration versus number of Ising spins, comparing the CUDA kernel on GH200, a PyTorch implementation on GH200, and the same PyTorch code on an Apple M2 Max via Metal Performance Shaders (MPS)}
